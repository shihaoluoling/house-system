...
public class SelectPlateDesk {
    ...
    private List<String> labelProduct;//产品标签
    ...
    public List<String> getLabelProduct() {
        return labelProduct;
    }

    public void setLabelProduct(List<String> labelProduct) {
